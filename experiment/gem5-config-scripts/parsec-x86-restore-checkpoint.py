...
board.set_kernel_disk_workload(
    kernel=KernelResource(
        local_path="/home/abj456/full_system_images/binaries/x86-linux-kernel-6.8.0-35-generic",
    ),
    ...
    checkpoint=pathlib.Path(
        f"/home/abj456/gem5-memSched/experiment/gem5-ckpts/{test_size}-checkpoint-{total_threads}-ckpt-{args.ckpt_sec}sec"
    ),
)
...
simulator.run(timing_sim_ticks)
